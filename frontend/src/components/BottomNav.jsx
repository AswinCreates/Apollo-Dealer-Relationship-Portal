...
export default function BottomNav() {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 z-50 bg-[#1e1b4b]/95 backdrop-blur-xl border-t border-white/10">
        ...
        {tabs.map((tab) => {
          ...
          return (
            ...
            >
              ...
              {isActive && (
                <div className="absolute top-0 w-8 h-0.5 bg-[#a78bfa] rounded-full" />
              )}
            </button>
          );
        })}
